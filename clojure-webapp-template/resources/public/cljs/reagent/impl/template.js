...
var G__6993 = o;
(G__6993[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__6997 = o;
(G__6997[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__6999__i < G__6999__a.length) {G__6999__a[G__6999__i] = arguments[G__6999__i + 0]; ++G__6999__i;}
  args = new cljs.core.IndexedSeq(G__6999__a,0,null);
} 
...
var G__7002 = props;
var G__7002__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__7002,cljs.core.cst$kw$id,id):G__7002);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__7002__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__7003){
var map__7004 = p__7003;
var map__7004__$1 = ((((!((map__7004 == null)))?(((((map__7004.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7004.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__7004):map__7004);
var props = map__7004__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7004__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__7004,map__7004__$1,props,class$){
return (function (c){
...
});})(map__7004,map__7004__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__7006){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7007__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__7007,map__7007__$1,on_write){
return (function (){
...
});})(node_value,map__7007,map__7007__$1,on_write))
);
} else {
...
var G__7010 = jsprops;
(G__7010["defaultValue"] = value);

(G__7010["onChange"] = ((function (G__7010,v,value,on_change){
return (function (p1__7009_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__7009_SHARP_);
});})(G__7010,v,value,on_change))
);
...
var vec__7013 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7013,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7013,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7013,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___7017 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___7017 == null)){
} else {
var key_7018 = temp__5461__auto___7017;
(jsprops["key"] = key_7018);
}
...
var temp__5461__auto___7019 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___7019 == null)){
} else {
var key_7020 = temp__5461__auto___7019;
reagent.impl.template.oset(jsprops,"key",key_7020);
}
...
var G__7021 = reagent.impl.template.__GT_NativeWrapper();
(G__7021["name"] = c);
...
var G__7022 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__7022) : reagent.impl.template.as_element.call(null,G__7022));
} else {
...
var len__4517__auto___7027 = arguments.length;
var i__4518__auto___7028 = (0);
while(true){
if((i__4518__auto___7028 < len__4517__auto___7027)){
args__4520__auto__.push((arguments[i__4518__auto___7028]));

var G__7029 = (i__4518__auto___7028 + (1));
i__4518__auto___7028 = G__7029;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq7025){
var G__7026 = cljs.core.first(seq7025);
var seq7025__$1 = cljs.core.next(seq7025);
var self__4504__auto__ = this;
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__7026,seq7025__$1);
});
...
break;
default:
var G__7032 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__7032;
continue;
...
var n__4394__auto___7034 = a.length;
var i_7035 = (0);
while(true){
if((i_7035 < n__4394__auto___7034)){
(a[i_7035] = reagent.impl.template.as_element((a[i_7035])));

var G__7036 = (i_7035 + (1));
i_7035 = G__7036;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4394__auto___7037 = a.length;
var i_7038 = (0);
while(true){
if((i_7038 < n__4394__auto___7037)){
var val_7039 = (a[i_7038]);
if(((cljs.core.vector_QMARK_(val_7039)) && ((reagent.impl.template.key_from_vec(val_7039) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_7038] = reagent.impl.template.as_element(val_7039));

var G__7040 = (i_7038 + (1));
i_7038 = G__7040;
continue;
} else {
}
...
var ctx = ({});
var vec__7041 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7041,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7041,(1),null);
...
var G__7044 = (cljs.core.count(argv) - first_child);
switch (G__7044) {
case (0):
...
var G__7045 = comp;
var G__7046 = jsprops;
var G__7047 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__7045,G__7046,G__7047) : reagent.impl.template.global$module$react.createElement.call(null,G__7045,G__7046,G__7047));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__7044){
