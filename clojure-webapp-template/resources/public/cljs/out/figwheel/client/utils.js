...
return (new CustomEvent(event_name,(function (){var obj31882 = {"detail":data};
return obj31882;
})()));
} else {
...
var f = (function (){var pred__31889 = cljs.core._EQ_;
var expr__31890 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31889.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31890))){
return ((function (pred__31889,expr__31890){
return (function (p1__31883_SHARP_){
return console.warn(p1__31883_SHARP_);
});
;})(pred__31889,expr__31890))
} else {
if(cljs.core.truth_(pred__31889.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31890))){
return ((function (pred__31889,expr__31890){
return (function (p1__31884_SHARP_){
return console.debug(p1__31884_SHARP_);
});
;})(pred__31889,expr__31890))
} else {
if(cljs.core.truth_(pred__31889.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31890))){
return ((function (pred__31889,expr__31890){
return (function (p1__31885_SHARP_){
return console.error(p1__31885_SHARP_);
});
;})(pred__31889,expr__31890))
} else {
return ((function (pred__31889,expr__31890){
return (function (p1__31886_SHARP_){
return console.log(p1__31886_SHARP_);
});
;})(pred__31889,expr__31890))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31893){
...
var opts = map__31894__$1;
var eval_fn = cljs.core.get.call(null,map__31894__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31896_SHARP_);
});})(new_def))
);
...
return (function (p__31897){
var vec__31898 = p__31897;
var ky = cljs.core.nth.call(null,vec__31898,(0),null);
var v = cljs.core.nth.call(null,vec__31898,(1),null);
...
if(cljs.core.truth_((function (){var and__3925__auto__ = (typeof localStorage !== 'undefined');
...
}catch (e31903){if((e31903 instanceof Error)){
var e = e31903;
return not_found;
} else {
throw e31903;
...
//# sourceMappingURL=utils.js.map?rel=1531390887707
